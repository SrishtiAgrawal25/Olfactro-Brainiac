...
#        self.COCurve = [2.3,0.72,-0.34]     # two points are taken from the curve. 
	...
	self.METHANECurve =[2.3,0.47,-0.37]
	self.BUTANECurve =[2.3,0.08,-0.52]
...
#	print(read)
#	print(self.Ro)
        a  = self.MQGetGasPercentage(read/self.Ro, self.GAS_LPG)
        a=round(a,5)
        val.append(a)
        b       = self.MQGetGasPercentage(read/self.Ro, self.GAS_SMOKE)
        val.append(round(b,5))
	c    = self.MQGetGasPercentage(read/self.Ro, self.GAS_METHANE)
        val.append(round(c,5))
	d   =  self.MQGetGasPercentage(read/self.Ro, self.GAS_BUTANE)
...
#	print(rs)
	...
	elif (gas_id == self.GAS_BUTANE ):
	    return self.MQGetPercentage(rs_ro_ratio, self.BUTANECurve)
	return 0
 ...
 #       print(rs_ro_ratio)
	x=math.log(rs_ro_ratio)
  #      print x
#	print(math.pow(10,(((math.log(0.5)-0.08)/(-0.52))+2.3)))
